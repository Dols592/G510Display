...
namespace G510Display.Source.Logitech
{
  class LogitechInterface
  {
    ...
    private const string DllName = "LogitechLcdEnginesWrapper_x64.dll";

//#if (_M_X64) || defined(__amd64__)
//  private const string DllName = "LogitechLcdEnginesWrapper_x64.dll";
//#else
//  private const string DllName = "LogitechLcdEnginesWrapper_x86.dll";
//#endif
